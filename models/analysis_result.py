...
class AnalysisResult:
    ...
    # Transparência sobre quantos candles sustentam esta análise --
    # ver `app.run_analysis`. `None` como default não quebra quem já
    # instancia `AnalysisResult` sem esse campo (ex.: testes existentes).
